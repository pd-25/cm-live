...
use Exception;
use DB;
class CmOtaRoomTypeSynchronize extends Model
{
    ...
    {
        $ota_room_type_id="";
        $cmOtaRoomTypeSynchDetails= CmOtaRoomTypeSynchronize::select('ota_room_type')
    ...
    public  function getSingleHotelRoomIdFromRoomSynch($ota_room_type,$hotel_id)
    {
        ...
        $cmOtaRoomTypeSynchDetails =  CmOtaRoomTypeSynchronize::select('*')
    ...
    {
        $cmOtaRoomTypeSynchDetails=CmOtaRoomTypeSynchronize::select('room_type')
