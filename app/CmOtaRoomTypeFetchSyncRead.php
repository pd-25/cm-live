...
class CmOtaRoomTypeFetchSyncRead extends Model
{
    ...
    {
        $roomTypeEx = CmOtaRoomTypeFetchSyncRead::where('ota_type_id',$ota_id)->where('hotel_id',$hotel_id)->where('room_type_id',$room_type_id)->where('ota_room_type',$ota_room_type)->where('is_trash',0)->first();
