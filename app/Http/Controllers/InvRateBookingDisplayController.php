    ...
    public function invData(Request $request){
        ...
        foreach($cm_hotel_otas as $otas){
            ...
            if($getdata){
                        ...
                        if($multiple_days != null){
                            if($multiple_days->$day == 0){
                                ...
                                if(empty($getdata1[0])){
                                    ...
                                    $channelwise_inventory[$key][7]=$getdata->restriction_status;
                                    $channelwise_inventory[$key][8]=$getdata->action_status;
                                }
                                else{
                                    ...
                                    if($multiple_days1 != null){
                                        if($multiple_days1->$day == 0){
                                            ...
                                            if(empty($getdata2)){
                                                ...
                                                $channelwise_inventory[$key][6]=$ota_id;
                                                $channelwise_inventory[$key][7]=$getdata2[0]->restriction_status;
                                                $channelwise_inventory[$key][8]=$getdata2[0]->action_status;
                                            }
                                        }
                                        else{
                                            ...
                                            $channelwise_inventory[$key][6]=$ota_id;
                                            $channelwise_inventory[$key][7]=$getdata1[0]->restriction_status;
                                            $channelwise_inventory[$key][8]=$getdata1[0]->action_status;
                                        }
                                    }
                                    else{
                                        $channelwise_inventory[$key][0]=$getdata1[0]->no_of_rooms;
                    ...
                    $channelwise_inventory[$key][7]='NA';
                    $channelwise_inventory[$key][8]=0;
                }
