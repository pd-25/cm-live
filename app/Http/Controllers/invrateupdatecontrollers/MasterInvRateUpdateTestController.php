...
use App\Http\Controllers\invrateupdatecontrollers\GoibiboInvRateTestController;
 ...
 */
class MasterInvRateUpdateTestController extends Controller
{
    ...
    protected $getdata_curlreq,$inventoryService,$hegInventoryRatePushUpdate;

    public function __construct(GoibiboInvRateTestController $goibiboInventoryRatePushUpdate,
