    ...
    public function actionIndex(Request $request)
    {
     ...
     // dd($array_data);
        if($postdata!='')
        {
            ...
            {
                if($array_data["accessKey"] == 'f920a7265a51fb5997d56a8ad402c43c4110f133')
                {
