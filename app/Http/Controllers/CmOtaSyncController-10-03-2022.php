...
///////////////////////// Fetch OTA Room Types By OTA ID////////////////////////////
    ...
    **/
    ...
    {
        $failure_message='Ota Room Type fetching failed';
        $data=CmOtaRoomTypeFetchSyncRead::join('kernel.room_type_table','room_type_table.room_type_id','=','cm_ota_room_type_synchronize.room_type_id')->where('cm_ota_room_type_synchronize.hotel_id',$hotel_id)->where('ota_type_id',$ota_id)->select('id','ota_room_type_name','room_type')->get();
        if($data)
        {
            return $data;
        }
...
public function getAllSyncRoomRateData(int $hotel_id,Request $request)
{
    ...
    **/
    ...
    {
        $failure_message='Ota room rate plan fetching failed';
        $data=CmOtaRatePlanFetchSyncRead::
        ...
        ->select('cm_ota_rate_plan_synchronize.id as id','ota_room_type_name','room_type','plan_name','ota_rate_plan_name','cm_ota_rate_plan_synchronize.created_at')
