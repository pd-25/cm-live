...
class InventoryStoreInOtaInventoryController extends Controller{
...
public function bookingdotcomUpdate($bucket_data,$booking_data)
{
		...
		->first();
		$url= '';
		$rateplan_code = isset($ratePlanTypeSynchronizeData->ota_rate_plan_id)?$ratePlanTypeSynchronizeData->ota_rate_plan_id:'NA';
