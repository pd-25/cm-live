...
class CmOtaBookingPushBucketController extends Controller
{
    ...
    public function actionBookingbucketengine()
    {
        ...
        //     $updateStatus = CmOtaBookingPushBucket::where('id',$status->bucket_id)->update(['is_update' => 0,'is_processed'=>0]);
        //     $dltstatus = CmOtaBucketTracker::where('hotel_id',$status->hotel_id)->delete();
        // }
