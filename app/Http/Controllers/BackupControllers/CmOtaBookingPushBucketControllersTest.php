    ...
    public function actionBookingbucketengine()
    {
      ...
      if(sizeof($cmOtaBookingPushBucketDetail)>0)
      {
        ...
        if($cmOtaBookingdetails){
            ...
            ->select('hotel_booking.room_type_id','hotel_booking.booking_date','hotel_booking.check_in','hotel_booking.rooms','hotel_booking.check_out','invoice_table.total_amount','user_table.first_name','user_table.last_name','user_table.email_id','user_table.mobile')
