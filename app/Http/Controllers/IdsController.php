...
class IdsController extends Controller
{
    ...
    public function pushIDSDetails(){
      $xml = '<OTA_HotelResNotifRQ xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns="http://www.opentravel.org/OTA/2003/05" EchoToken="f65b2d0b-b772-4496-a138-45267d1c3ae9" TimeStamp="2022-03-07T00:00:00.00+05:30" Version="3.002" ResStatus="Cancel">
        <POS>
          <Source>
            <RequestorID Type="22" ID="Bookingjini" />
            <BookingChannel Type="CHANNEL">
        ...
        <HotelReservations>
          <HotelReservation CreateDateTime="2022-03-07T00:00:00.00+05:30">
            <UniqueID Type="14" ID="07032260233" ID_Context="Bookingjini" />
            <RoomStays><RoomStay>
                    <RoomTypes>
                        <RoomType NumberOfUnits="1" RoomTypeCode="POS" />
                    </RoomTypes>
                    <RatePlans>
                    <RatePlan RatePlanCode="1" MealPlanCode="EP" />
                    </RatePlans>
                    <RoomRates>
                        <RoomRate RoomTypeCode="POS" RatePlanCode="1"><Rates>
                                <Rate EffectiveDate="2022-03-25" ExpireDate="2022-03-26" RateTimeUnit="Day" UnitMultiplier="1">
                                    <Base AmountAfterTax="56640" AmountBeforeTax="48000" CurrencyCode="INR">
                                    <Taxes Amount="8640" CurrencyCode="INR" />
                                    </Base>
                                </Rate>
                            </Rates></RoomRate>
                    </RoomRates>
                ...
                <TimeSpan Start="2022-03-25" End="2022-03-26" />
                <Total AmountIncludingMarkup="56640" AmountAfterTax="56640" AmountBeforeTax="48000" CurrencyCode="INR">
                  <Taxes Amount="8640" CurrencyCode="INR" />
                </Total>
                <BasicPropertyInfo HotelCode="6585" />
                <ResGuestRPHs>
                  <ResGuestRPH RPH="1" />
                </ResGuestRPHs>
              </RoomStay></RoomStays>
                ...
                <Profiles>
                  <ProfileInfo>
                    <Profile ProfileType="1">
                      <Customer>
                        <PersonName>
                          <GivenName>Rajan</GivenName>
                          <Surname>Bhatnagar </Surname>
                        </PersonName>
                        <Telephone PhoneTechType="1" PhoneNumber="1713140138" FormattedInd="false" DefaultInd="true" />
                        <Email EmailType="1">rajan221@icloud.com</Email>
                        <Address>
                          <AddressLine>NA</AddressLine>
                          <CityName>NA</CityName>
                          <CountryName Code="na">NA</CountryName>
    ...
    public function pushReservations($xml,$ids_id)
    {
        ...
        if(isset($array_data['Success'])){
            if(IdsReservation::where('id',$ids_id)->update(['ids_confirm'=>1,'ids_response_xml'=>$result])){
                return true;
            }
            else{
                $resp_ids = IdsReservation::where('id',$ids_id)->update(['ids_response_xml'=>$result]);
                return false;
            }
        }else{
            $resp_ids = IdsReservation::where('id',$ids_id)->update(['ids_response_xml'=>$result]);
